	...
	<div class="page_section">
		...
		<div id="content" class="section bragger full">
			...
			<section id="entrepreneurship">
				<header>
					<div class="container">
						<h2>I&apos;me driven to <em>create</em> new ventures</h2>
					</div>
				</header>
				<div class="container">
					<p class="lede">I&apos;ve started <strong>3</strong> companies of my own and am eager to take on new opportunities at Google.</p>
